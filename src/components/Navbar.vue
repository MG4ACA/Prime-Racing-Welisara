      ...
      <div class="flex items-center justify-between h-20">
        ...
        <div class="hidden md:flex items-center space-x-8">
          <router-link
            ...
            :class="
              scrolled ? 'text-gray-600 hover:text-honda-red' : 'text-gray-200 hover:text-honda-red'
            "
          >
            {{ item.label }}
          </router-link>
      ...
      <div v-if="mobileMenuOpen" class="md:hidden bg-white border-t border-gray-100 shadow-xl">
        <div class="section-container py-4 space-y-3">
          <router-link
            ...
            class="block text-gray-700 hover:text-honda-red transition-all duration-300 py-2 font-medium"
          >
            {{ item.label }}
          </router-link>
          <router-link
            to="/test-ride"
            @click="mobileMenuOpen = false"
            class="btn-primary-honda block text-center mt-4"
          >
            Inquire Now
          </router-link>
        </div>
