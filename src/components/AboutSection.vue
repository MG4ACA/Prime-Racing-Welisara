<template>
  <div class="section-container">
    <div class="grid md:grid-cols-2 gap-12 items-center">
      <!-- Text Content -->
      <div class="space-y-6">
        <div class="flex items-center space-x-2 text-ktm-orange">
          <Award class="w-6 h-6" />
        ...
        <div class="space-y-4 text-gray-300 leading-relaxed">
          <p>
            At
            <span class="text-white font-semibold">Prime Racing Welisara</span>
            , we're passionate about delivering the ultimate riding experience. Located at
            <span class="text-ktm-orange">No. 47, Ragama Road, Welisara</span>
            , we specialize in premium motorcycles from the world's leading manufacturers.
          </p>
          ...
          <p>
            ...
            dedicated to helping you find the perfect ride that matches your style and needs.
          </p>
        </div>
      ...
      <div class="grid grid-cols-2 gap-4">
        <div v-for="(feature, index) in features" :key="index" class="card group cursor-pointer">
          <component
            :is="feature.icon"
            class="w-10 h-10 text-ktm-orange mb-4 group-hover:scale-110 transition-transform duration-300"
            :stroke-width="1.5"
          />
...
<script setup>
import { Award, Shield, Trophy, Users, Wrench } from 'lucide-vue-next';

const features = [
  {
    icon: Shield,
    title: 'Quality Assured',
    description: 'Only genuine, certified motorcycles from authorized dealers',
  },
  {
    icon: Wrench,
    title: 'Expert Service',
    description: 'Professional maintenance and repair by certified technicians',
  },
  {
    icon: Users,
    title: 'Customer First',
    description: 'Dedicated support before, during, and after your purchase',
  },
  {
    icon: Trophy,
    title: 'Best Prices',
